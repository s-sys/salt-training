# Instale a feature do Windows Telnet-Client no minion6.

# Visualize todas as features do Windows com o comando abaixo:
# salt 'minion6' win_servermanager.list_available
...
# Faça a instalação da feature Telnet-Client, conforme comando abaixo:
# salt --timeout=30 'minion6' win_servermanager.install Telnet-Client
